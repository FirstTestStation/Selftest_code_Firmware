...
\item \href{raspberrypi-swd.cfg}{\texttt{ {\ttfamily raspberrypi-\/swd.\+cfg}}} need to be copied on opencd interface folder (../.pico-\/sdk/openocd/0.\+12.\+0+dev/scripts/interface/) if GPIO pins is used to debug project.
\end{DoxyItemize}\hypertarget{md_README_autotoc_md5}{}\doxysection{Installation}\label{md_README_autotoc_md5}

\begin{DoxyItemize}
\item The Files \href{build/IO_selftest/SELFTEST_CODE.uf2}{\texttt{ \textquotesingle{}SELFTEST\+\_\+\+CODE.\+uf2\textquotesingle{}}} contains the firmware to be loaded on the Pico RP2040 board using USB cable and boot button.
